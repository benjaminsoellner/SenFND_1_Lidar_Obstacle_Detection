...
std::vector<Car> initHighway(bool renderScene, pcl::visualization::PCLVisualizer::Ptr& viewer)
{
    ...
    Car egoCar( Vect3(0,0,0), Vect3(4,2,2), Color(0.2,0,0), "egoCar");
    Car car1( Vect3(15,0,0), Vect3(4,2,2), Color(0,0,0.2), "car1");
    Car car2( Vect3(8,-4,0), Vect3(4,2,2), Color(0,0.2,0), "car2");	
    Car car3( Vect3(-12,4,0), Vect3(4,2,2), Color(0,0.2,0.2), "car3");
...
void simpleHighway(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
    ...
    // create Lidar and scan point cloud
